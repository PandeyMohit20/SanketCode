...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    Queue<Node> stat = new LinkedList<Node>();
    stat.add(new TwoOperandNode('*',new AddressOperand(0),new RegisterOperand(1)));
    stat.add(new TwoOperandNode('*',new AddressOperand(1),new RegisterOperand(2)));
    stat.add(new TwoOperandNode('/',new RegisterOperand(2),new RegisterOperand(3)));
    baseNodes.add(new StatementsNode(stat));
